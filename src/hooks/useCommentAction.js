...
export function useCommentAction() {
    ...
    const statusCreateComment = useAppSelector((state) => state.comment.statusCreate)
    ...
    return { addComment, fetchComments, statusComment, statusCreateComment, allComments }
