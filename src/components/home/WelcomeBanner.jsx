    ...
    return (
        <div className="border-2 border-neutral-300 py-3 px-6 rounded-md relative bg-neutral-800">
            ...
            <div className='italic'>
                <p className='mb-1'>
                    ¡Hola! Nos alegra verte en ForoMania, un espacio donde puedes compartir tus ideas,
                    aprender de los demás y crecer junto a la comunidad. Queremos recordarte la importancia
